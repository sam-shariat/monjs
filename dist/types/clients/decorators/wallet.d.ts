...
export declare const ensWalletActions: <TTransport extends Transport = Transport, TChain extends ChainWithEns = ChainWithEns, TAccount extends Account | undefined = Account | undefined>(client: {
    ...
    prepareTransactionRequest: <const TRequest extends import("viem").PrepareTransactionRequestRequest<TChain, TChainOverride>, TChainOverride extends import("viem").Chain | undefined = undefined, TAccountOverride extends `0x${string}` | Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<TChain, TAccount, TChainOverride, TAccountOverride, TRequest>) => Promise<import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<import("viem").Chain, TChainOverride>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<import("viem").Chain, TChainOverride> extends infer T_12 ? T_12 extends import("viem").DeriveChain<import("viem").Chain, TChainOverride> ? T_12 extends import("viem").Chain ? {
        ...
        chain?: undefined;
    } : never : never) & (import("viem").DeriveAccount<TAccount, TAccountOverride> extends infer T_2 ? T_2 extends import("viem").DeriveAccount<TAccount, TAccountOverride> ? T_2 extends Account ? {
        account: T_2;
        from: `0x${string}`;
    } : {
        account?: undefined;
    ...
    sendTransaction: <const TRequest_1 extends import("viem").SendTransactionRequest<TChain, TChainOverride_1>, TChainOverride_1 extends import("viem").Chain | undefined = undefined>(args: import("viem").SendTransactionParameters<TChain, TAccount, TChainOverride_1, TRequest_1>) => Promise<`0x${string}`>;
    signMessage: (args: import("viem").SignMessageParameters<TAccount>) => Promise<`0x${string}`>;
    signTransaction: <TChainOverride_2 extends import("viem").Chain | undefined>(args: import("viem").SignTransactionParameters<TChain, TAccount, TChainOverride_2>) => Promise<`0x02${string}` | `0x01${string}` | `0x03${string}` | import("viem").TransactionSerializedLegacy>;
