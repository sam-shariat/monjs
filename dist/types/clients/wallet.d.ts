...
export declare const createEnsWalletClient: <TTransport extends Transport, TChain extends ChainWithBaseContracts, TAccountOrAddress extends `0x${string}` | Account | undefined = undefined>({ account, chain, key, name, transport, pollingInterval, }: EnsWalletClientConfig<TTransport, TChain, TAccountOrAddress>) => {
    ...
    prepareTransactionRequest: <const TRequest extends import("viem").PrepareTransactionRequestRequest<CheckedChainWithEns<TChain>, TChainOverride>, TChainOverride extends import("viem").Chain | undefined = undefined, TAccountOverride extends `0x${string}` | Account | undefined = undefined>(args: import("viem").PrepareTransactionRequestParameters<CheckedChainWithEns<TChain>, ParseAccount<TAccountOrAddress>, TChainOverride, TAccountOverride, TRequest>) => Promise<import("viem").UnionRequiredBy<Extract<import("viem").UnionOmit<import("viem").ExtractChainFormatterParameters<import("viem").DeriveChain<import("viem").Chain, TChainOverride>, "transactionRequest", import("viem").TransactionRequest>, "from"> & (import("viem").DeriveChain<import("viem").Chain, TChainOverride> extends infer T_12 ? T_12 extends import("viem").DeriveChain<import("viem").Chain, TChainOverride> ? T_12 extends import("viem").Chain ? {
        ...
        chain?: undefined;
    } : never : never) & (import("viem").DeriveAccount<ParseAccount<TAccountOrAddress>, TAccountOverride> extends infer T_2 ? T_2 extends import("viem").DeriveAccount<ParseAccount<TAccountOrAddress>, TAccountOverride> ? T_2 extends Account ? {
        account: T_2;
        from: `0x${string}`;
    } : {
        account?: undefined;
    ...
    sendTransaction: <const TRequest_1 extends import("viem").SendTransactionRequest<CheckedChainWithEns<TChain>, TChainOverride_1>, TChainOverride_1 extends import("viem").Chain | undefined = undefined>(args: import("viem").SendTransactionParameters<CheckedChainWithEns<TChain>, ParseAccount<TAccountOrAddress>, TChainOverride_1, TRequest_1>) => Promise<`0x${string}`>;
    signMessage: (args: import("viem").SignMessageParameters<ParseAccount<TAccountOrAddress>>) => Promise<`0x${string}`>;
    signTransaction: <TChainOverride_2 extends import("viem").Chain | undefined>(args: import("viem").SignTransactionParameters<CheckedChainWithEns<TChain>, ParseAccount<TAccountOrAddress>, TChainOverride_2>) => Promise<`0x02${string}` | `0x01${string}` | `0x03${string}` | import("viem").TransactionSerializedLegacy>;
